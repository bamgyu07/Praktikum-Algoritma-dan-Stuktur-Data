...
public class BinaryTree02 {
    ...
    void delete(double ipk){
        ...
        if(current == null){
            ...
            //jika ada anak (leaf) maka node dihapus
            ...
            } else if (current.left == null){ //jika hanya punya satu anak (kanan)
                if (current == root){
                    root = current.right;
                } else {
                    if (isLeftChild){
            ...
            } else if (current.right == null){ //jika satu anak (kiri)
                if(current == root){
                    root = current.left;
                } else {
                    if (isLeftChild){
    ...
    Node02 addRekursif(Node02 current, Mahasiswa02 mahasiswa){
        if (current == null){
    ...
    void tampilIPKdiAtas(Node02 node, double ipkBatas) {
        if (node != null) {
